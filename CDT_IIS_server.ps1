...
# DNS outbound
netsh advfirewall firewall add rule name="DNS out" dir=out remoteport=53 protocol=UDP action=allow
...
#enables port 445 for AD services
netsh advfirewall firewall add rule name="AD in" dir=in localport=445 protocol=TCP action=allow
netsh advfirewall firewall add rule name="AD out" dir=out remoteport=445 protocol=TCP action=allow 
